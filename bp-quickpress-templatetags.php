...
function bp_quickpress_switch_blog_form() {
		...
		$form_action = $bp->loggedin_user->domain . $bp->blogs->slug . '/'.__('quickpress', 'bp-quickpress-slugs' ).'/switch-blog';
...
function bp_quickpress_creation_form() {
	...
	$form_action = $bp->loggedin_user->domain . $bp->blogs->slug . '/'.__('quickpress', 'bp-quickpress-slugs' ).'/'.__( 'save', 'bp-quickpress-slugs' );
...
<?php
	...
	?>
		...
		<p>
			<label for="posttext"><?php _e('Description');?><small> - <em><?php _e('HTML allowed','bp-quickpress');?></em></small></label><br/>
			<textarea name="posttext" id="posttext" rows="3"></textarea>
		</p>
...
?>
	<form id="bp_quickpress_edit_post" class="standard-form" name="bp_quickpress_edit_post" method="post" action="<?php echo $form_action; ?>">
		<p>
			<label for="blog_id"><?php _e('Blog');?></label><br/>
			<em>
			<?php
...
function bp_quickpress_tags($blog_id=false) {
	...
	$output.='<p>';
	$output.='<label for="tags">'.__('Tags').'</label><br/>';
...
function bp_quickpress_categories($blog_id=false) {
	...
	$output.='<p>';
	$output.='<label for="categories">'.__('Categories').'</label><br/>';
